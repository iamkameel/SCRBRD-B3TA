...
import { AlertTriangle, Users, MapPin, AlertCircle, Shield, ClipboardList, Trophy, UserCog, ArrowRight, Database, Mail, ThumbsUp, ThumbsDown, Loader2 } from 'lucide-react';
import { Alert, AlertTitle, AlertDescription } from '@/components/ui/alert';
import { Button } from '@/components/ui/button';
import { format, isToday, startOfWeek, endOfWeek, isWithinInterval } from "date-fns";
import { Badge } from "@/components/ui/badge";
import { cn } from "@/lib/utils";
import type { Competition, Team, FixtureConflict, Person, StandingTeam, LeaderboardPlayer, Match, AssignmentRequest } from '@/lib/data';
