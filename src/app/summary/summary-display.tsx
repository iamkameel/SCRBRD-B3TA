...
export function SummaryDisplay({ summary, team1Name, team2Name }: { summary: string; team1Name?: string; team2Name?: string }) {
  ...
  return (
    <Card className="max-w-4xl mx-auto animate-in fade-in-50 duration-500">
      <CardHeader>
        ...
        <CardDescription>Here is the AI-generated summary of the match.</CardDescription>
      </CardHeader>
      <CardContent>
