...
export default function FieldsClient({ fields, schools, groundskeepers }: { fields: Field[], schools: School[], groundskeepers: Person[] }) {
  ...
  return (
    <>
      ...
      {isFieldDialogOpen && <FieldDialog mode={dialogMode} field={selectedField ?? undefined} schools={schools} groundskeepers={groundskeeper**s**} open={isFieldDialogOpen} onOpenChange={setIsFieldDialogOpen} />}
