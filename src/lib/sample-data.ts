...
export const sampleData = {
    ...
    people: [
        ...
        { personId: 'p_3', firstName: 'Joe', lastName: 'Root', email: 'joe.r@example.com', roles: ['Player'], activeRole: 'Player', notificationPreferences: { email: true, push: false } },
        { personId: 'p_4', firstName: 'Stuart', lastName: 'Broad', email: 'stuart.b@example.com', roles: ['Player'], activeRole: 'Player', notificationPreferences: { email: true, push: false } },
        { personId: 'p_5', firstName: 'Jonny', lastName: 'Bairstow', email: 'jonny.b@example.com', roles: ['Player'], activeRole: 'Player', notificationPreferences: { email: true, push: false } },
        { personId: 'p_6', firstName: 'Jos', lastName: 'Buttler', email: 'jos.b@example.com', roles: ['Player'], activeRole: 'Player', notificationPreferences: { email: true, push: false } },
        { personId: 'p_7', firstName: 'Chris', lastName: 'Woakes', email: 'chris.w@example.com', roles: ['Player'], activeRole: 'Player', notificationPreferences: { email: true, push: false } },
        { personId: 'p_8', firstName: 'Mark', lastName: 'Wood', email: 'mark.w@example.com', roles: ['Player'], activeRole: 'Player', notificationPreferences: { email: true, push: false } },
        ...
        { personId: 'p_14', firstName: 'Rohit', lastName: 'Sharma', email: 'rohit.s@example.com', roles: ['Player', 'Vice-Captain'], activeRole: 'Player', notificationPreferences: { email: true, push: false } },
        { personId: 'p_15', firstName: 'Jasprit', lastName: 'Bumrah', email: 'jasprit.b@example.com', roles: ['Player'], activeRole: 'Player', notificationPreferences: { email: true, push: false } },
        { personId: 'p_16', firstName: 'KL', lastName: 'Rahul', email: 'kl.rahul@example.com', roles: ['Player'], activeRole: 'Player', notificationPreferences: { email: true, push: false } },
        { personId: 'p_17', firstName: 'Rishabh', lastName: 'Pant', email: 'rishabh.p@example.com', roles: ['Player'], activeRole: 'Player', notificationPreferences: { email: true, push: false } },
        { personId: 'p_18', firstName: 'Hardik', lastName: 'Pandya', email: 'hardik.p@example.com', roles: ['Player'], activeRole: 'Player', notificationPreferences: { email: true, push: false } },
        { personId: 'p_19', firstName: 'Ravindra', lastName: 'Jadeja', email: 'ravindra.j@example.com', roles: ['Player'], activeRole: 'Player', notificationPreferences: { email: true, push: false } },
        { personId: 'p_20', firstName: 'Mohammed', lastName: 'Shami', email: 'mohammed.s@example.com', roles: ['Player'], activeRole: 'Player', notificationPreferences: { email: true, push: false } },
        ...
        { personId: 'p_26', firstName: 'Trent', lastName: 'Boult', email: 'trent.b@example.com', roles: ['Player', 'Vice-Captain'], activeRole: 'Player', notificationPreferences: { email: true, push: false } },
        { personId: 'p_27', firstName: 'Ross', lastName: 'Taylor', email: 'ross.t@example.com', roles: ['Player'], activeRole: 'Player', notificationPreferences: { email: true, push: false } },
        { personId: 'p_28', firstName: 'Devon', lastName: 'Conway', email: 'devon.c@example.com', roles: ['Player'], activeRole: 'Player', notificationPreferences: { email: true, push: false } },
        { personId: 'p_29', firstName: 'Kyle', lastName: 'Jamieson', email: 'kyle.j@example.com', roles: ['Player'], activeRole: 'Player', notificationPreferences: { email: true, push: false } },
        { personId: 'p_30', firstName: 'Tom', lastName: 'Latham', email: 'tom.l@example.com', roles: ['Player'], activeRole: 'Player', notificationPreferences: { email: true, push: false } },
        { personId: 'p_31', firstName: 'Mitchell', lastName: 'Santner', email: 'mitchell.s@example.com', roles: ['Player'], activeRole: 'Player', notificationPreferences: { email: true, push: false } },
        { personId: 'p_32', firstName: 'Tim', lastName: 'Southee', email: 'tim.s@example.com', roles: ['Player'], activeRole: 'Player', notificationPreferences: { email: true, push: false } },
        ...
        { personId: 'p_38', firstName: 'Shaheen', lastName: 'Afridi', email: 'shaheen.a@example.com', roles: ['Player', 'Vice-Captain'], activeRole: 'Player', notificationPreferences: { email: true, push: false } },
        { personId: 'p_39', firstName: 'Mohammad', lastName: 'Rizwan', email: 'mohammad.r@example.com', roles: ['Player'], activeRole: 'Player', notificationPreferences: { email: true, push: false } },
        { personId: 'p_40', firstName: 'Shadab', lastName: 'Khan', email: 'shadab.k@example.com', roles: ['Player'], activeRole: 'Player', notificationPreferences: { email: true, push: false } },
        { personId: 'p_41', firstName: 'Fakhar', lastName: 'Zaman', email: 'fakhar.z@example.com', roles: ['Player'], activeRole: 'Player', notificationPreferences: { email: true, push: false } },
        { personId: 'p_42', firstName: 'Haris', lastName: 'Rauf', email: 'haris.r@example.com', roles: ['Player'], activeRole: 'Player', notificationPreferences: { email: true, push: false } },
        { personId: 'p_43', firstName: 'Imam-ul-Haq', email: 'imam.h@example.com', roles: ['Player'], activeRole: 'Player', notificationPreferences: { email: true, push: false } },
        { personId: 'p_44', firstName: 'Hasan', lastName: 'Ali', email: 'hasan.a@example.com', roles: ['Player'], activeRole: 'Player', notificationPreferences: { email: true, push: false } },
