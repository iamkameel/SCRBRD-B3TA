...
export const sampleData = {
    ...
    people: [
        ...
        { personId: 'p_1', firstName: 'Liam', lastName: 'Smith', email: 'liam.smith@example.com', roles: ['Player', 'Captain'] },
        { personId: 'p_2', firstName: 'Noah', lastName: 'Jones', email: 'noah.jones@example.com', roles: ['Player'] },
        { personId: 'p_3', firstName: 'Oliver', lastName: 'Williams', email: 'oliver.w@example.com', roles: ['Player', 'Vice-Captain'] },
        { personId: 'p_4', firstName: 'Elijah', lastName: 'Brown', email: 'elijah.brown@example.com', roles: ['Player'] },
        { personId: 'p_5', firstName: 'James', lastName: 'Davis', email: 'james.davis@example.com', roles: ['Player'] },
        { personId: 'p_6', firstName: 'Benjamin', lastName: 'Miller', email: 'benjamin.m@example.com', roles: ['Player'] },
        { personId: 'p_7', firstName: 'Lucas', lastName: 'Wilson', email: 'lucas.wilson@example.com', roles: ['Player'] },
        { personId: 'p_8', firstName: 'Henry', lastName: 'Moore', email: 'henry.moore@example.com', roles: ['Player'] },
        { personId: 'p_9', firstName: 'Alexander', lastName: 'Taylor', email: 'alex.t@example.com', roles: ['Player'] },
        { personId: 'p_10', firstName: 'Mason', lastName: 'Anderson', email: 'mason.a@example.com', roles: ['Player'] },
        { personId: 'p_11', firstName: 'Michael', lastName: 'Thomas', email: 'michael.t@example.com', roles: ['Player', 'Driver'] },
        { personId: 'p_12', firstName: 'David', lastName: 'Robinson', email: 'david.r@example.com', roles: ['Coach'] },
        
        // Oakridge Oaks (12 people)
        { personId: 'p_13', firstName: 'Charlotte', lastName: 'Harris', email: 'charlotte.h@example.com', roles: ['Player', 'Captain'] },
        { personId: 'p_14', firstName: 'Amelia', lastName: 'Clark', email: 'amelia.c@example.com', roles: ['Player'] },
        { personId: 'p_15', firstName: 'Evelyn', lastName: 'Lewis', email: 'evelyn.l@example.com', roles: ['Player', 'Vice-Captain'] },
        { personId: 'p_16', firstName: 'Abigail', lastName: 'Walker', email: 'abigail.w@example.com', roles: ['Player'] },
        { personId: 'p_17', firstName: 'Harper', lastName: 'Hall', email: 'harper.h@example.com', roles: ['Player'] },
        { personId: 'p_18', firstName: 'Sophia', lastName: 'Allen', email: 'sophia.a@example.com', roles: ['Player'] },
        { personId: 'p_19', firstName: 'Isabella', lastName: 'Young', email: 'isabella.y@example.com', roles: ['Player'] },
        { personId: 'p_20', firstName: 'Mia', lastName: 'King', email: 'mia.king@example.com', roles: ['Player'] },
        { personId: 'p_21', firstName: 'Ava', lastName: 'Wright', email: 'ava.w@example.com', roles: ['Player'] },
        { personId: 'p_22', firstName: 'Olivia', lastName: 'Scott', email: 'olivia.s@example.com', roles: ['Player'] },
        { personId: 'p_23', firstName: 'Emma', lastName: 'Green', email: 'emma.g@example.com', roles: ['Player'] },
        { personId: 'p_24', firstName: 'Susan', lastName: 'Hill', email: 'susan.h@example.com', roles: ['Coach', 'Driver'] },
