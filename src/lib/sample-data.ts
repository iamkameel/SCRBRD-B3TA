...
const adminAndStaff = [
    ...
    { personId: 'p_kameel', firstName: 'Kameel', lastName: 'Kalyan', email: 'kameel@maverickdesign.co.za', roles: ['Admin', 'Sportsmaster', 'Umpire', 'Scorer', 'School Admin', 'Coach', 'Assistant Coach'], activeRole: 'Admin', assignedSchools: ['MHS', 'HC'], notificationPreferences: { email: true, push: false } },
...
const sampleDataPrecursor = {
    ...
    fields: [
        { fieldId: 'field_4', name: "Bowden's Field", schoolId: 'WBHS', status: 'Available', location: 'Jan Hofmeyr Road, Westville', coordinates: { lat: -29.8247, lon: 30.9240 } },
        { fieldId: 'field_5', name: 'WBHS Cricket Nets', schoolId: 'WBHS', status: 'Available', location: 'Southeast corner of Bowden\'s Field', coordinates: { lat: -29.8250, lon: 30.9245 }, facilities: ['nets'] },
        { fieldId: 'field_6', name: 'Commons Field', schoolId: 'WBHS', status: 'Available', location: 'Adjacent to M13 Freeway', coordinates: { lat: -29.8285, lon: 30.9270 }, facilities: ['nets', 'changing_rooms'] },
        { fieldId: 'field_3', name: "Old Boys' Ground", schoolId: 'DHS', status: 'Available', location: 'Musgrave, Durban', coordinates: { lat: -29.8830, lon: 31.0500 } },
        { fieldId: 'field_7', name: 'Barry Richards Centre', schoolId: 'DHS', status: 'Available', location: 'DHS Campus, Musgrave', coordinates: { lat: -29.8830, lon: 31.0500 }, facilities: ['nets', 'pavilion'] },
        { fieldId: 'field_1', name: 'Roy Gathorne Oval', schoolId: 'MHS', status: 'Available', location: 'Michaelhouse Estate, Balgowan', coordinates: { lat: -29.3995, lon: 30.0472 } },
        { fieldId: 'field_8', name: 'Hannahs Oval', schoolId: 'MHS', status: 'Available', location: 'Michaelhouse Estate, Balgowan', coordinates: { lat: -29.3995, lon: 30.0472 } },
        { fieldId: 'field_9', name: 'Inglis Indoor Centre', schoolId: 'MHS', status: 'Available', location: 'Michaelhouse Estate, Balgowan', coordinates: { lat: -29.4000, lon: 30.0465 }, facilities: ['nets'] },
        { fieldId: 'field_2', name: 'Hart-Davis Oval', schoolId: 'HC', status: 'Available', location: 'Hilton College Estate, Hilton', coordinates: { lat: -29.3600, lon: 30.3300 }, facilities: ['nets', 'pavilion', 'scoreboard'] },
    ],
    fieldAssignments: [],
    vehicles: [
