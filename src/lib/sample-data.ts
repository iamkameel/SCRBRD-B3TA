...
export const sampleData = {
    ...
    fields: [
        // School-owned fields
        { fieldId: 'field_1', schoolId: 'school_1', name: 'John Medlicott Oval', alias: 'Main Oval', location: 'Michaelhouse, Balgowan', size: 'Full Size', pitchType: 'Natural Turf', facilities: ['pavilion', 'toilets', 'nets'], amenities: ['seating', 'changing_rooms'], status: 'Available', contactPerson: 'Mark Taylor', contactPhone: '555-0101', notes: 'Grass Cover: 95%.\nMoisture: Ideal.\nFirmness: Good.\nPristine condition with excellent drainage after rain.' },
        { fieldId: 'field_2', schoolId: 'school_2', name: 'Hart-Davis Oval', alias: 'The Hart-Davis', location: 'Hilton College, Hilton', size: 'Full Size', pitchType: 'Natural Turf', facilities: ['pavilion', 'scoreboard'], amenities: ['seating', 'parking'], status: 'Available', contactPerson: 'Grounds Dept.', contactPhone: '555-0102', notes: '' },
        { fieldId: 'field_3', schoolId: 'school_3', name: 'Goldstones', location: 'Maritzburg College, Pietermaritzburg', size: 'Full Size', pitchType: 'Natural Turf', facilities: ['nets'], amenities: ['seating', 'food_drink'], status: 'Available' },
        ...
        { fieldId: 'field_5', schoolId: 'school_5', name: 'Dixons', location: 'Glenwood High, Durban', size: 'Full Size', pitchType: 'Hybrid Reinforced', facilities: ['pavilion'], amenities: [], status: 'Available', notes: 'Desso GrassMaster hybrid pitch installed 2023. Excellent wear resistance.' },
        { fieldId: 'field_6', schoolId: 'school_6', name: 'Bowdens', location: 'WBHS, Westville', size: 'Full Size', pitchType: 'Natural Turf', facilities: ['nets', 'toilets'], amenities: ['parking'], status: 'Available' },
        { fieldId: 'field_7', schoolId: 'school_7', name: 'AH Smith Oval', location: 'Kearsney College, Botha\'s Hill', size: 'Full Size', pitchType: 'Natural Turf', facilities: ['pavilion', 'nets'], amenities: ['seating'], status: 'Available' },
        ...
        { fieldId: 'field_9', schoolId: 'school_9', name: 'Northwood Oval', location: 'Northwood School, Durban North', size: 'Full Size', pitchType: 'Artificial Astro-Turf', facilities: ['scoreboard', 'nets'], amenities: [], status: 'Available', notes: 'Fast, low-maintenance astro-turf. Good for T20s.' },
    ...
    people: [
        ...
        { personId: 'p_2', firstName: 'Ben', lastName: 'Stokes', email: 'ben.s@example.com', roles: ['Player', 'Vice-Captain'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_3', firstName: 'Joe', lastName: 'Root', email: 'joe.r@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_4', firstName: 'Stuart', lastName: 'Broad', email: 'stuart.b@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_5', firstName: 'Jonny', lastName: 'Bairstow', email: 'jonny.b@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_6', firstName: 'Jos', lastName: 'Buttler', email: 'jos.b@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_7', firstName: 'Chris', lastName: 'Woakes', email: 'chris.w@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_8', firstName: 'Mark', lastName: 'Wood', email: 'mark.w@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_9', firstName: 'Adil', lastName: 'Rashid', email: 'adil.r@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_10', firstName: 'Jofra', lastName: 'Archer', email: 'jofra.a@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_11', firstName: 'Sam', lastName: 'Curran', email: 'sam.c@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_12', firstName: 'Trevor', lastName: 'Bayliss', email: 'trevor.b@coach.com', roles: ['Coach'], notificationPreferences: { email: true, push: false } },

        // Hilton College Players & Coach
        { personId: 'p_13', firstName: 'Virat', lastName: 'Kohli', email: 'virat.k@example.com', roles: ['Player', 'Captain'], profileImageUrl: 'https://placehold.co/400x400.png', notificationPreferences: { email: true, push: false } },
        { personId: 'p_14', firstName: 'Rohit', lastName: 'Sharma', email: 'rohit.s@example.com', roles: ['Player', 'Vice-Captain'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_15', firstName: 'Jasprit', lastName: 'Bumrah', email: 'jasprit.b@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_16', firstName: 'KL', lastName: 'Rahul', email: 'kl.rahul@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_17', firstName: 'Rishabh', lastName: 'Pant', email: 'rishabh.p@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_18', firstName: 'Hardik', lastName: 'Pandya', email: 'hardik.p@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_19', firstName: 'Ravindra', lastName: 'Jadeja', email: 'ravindra.j@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_20', firstName: 'Mohammed', lastName: 'Shami', email: 'mohammed.s@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_21', firstName: 'Shikhar', lastName: 'Dhawan', email: 'shikhar.d@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_22', firstName: 'Yuzvendra', lastName: 'Chahal', email: 'yuzvendra.c@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_23', firstName: 'Suryakumar', lastName: 'Yadav', email: 'suryakumar.y@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_24', firstName: 'Ravi', lastName: 'Shastri', email: 'ravi.s@coach.com', roles: ['Coach', 'Driver'], notificationPreferences: { email: true, push: false } },
        
        // Maritzburg College Players
        { personId: 'p_25', firstName: 'Kane', lastName: 'Williamson', email: 'kane.w@example.com', roles: ['Player', 'Captain'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_26', firstName: 'Trent', lastName: 'Boult', email: 'trent.b@example.com', roles: ['Player', 'Vice-Captain'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_27', firstName: 'Ross', lastName: 'Taylor', email: 'ross.t@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        // ... more players for Maritzburg College
        { personId: 'p_28', firstName: 'Devon', lastName: 'Conway', email: 'devon.c@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_29', firstName: 'Kyle', lastName: 'Jamieson', email: 'kyle.j@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_30', firstName: 'Tom', lastName: 'Latham', email: 'tom.l@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_31', firstName: 'Mitchell', lastName: 'Santner', email: 'mitchell.s@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_32', firstName: 'Tim', lastName: 'Southee', email: 'tim.s@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_33', firstName: 'Lockie', lastName: 'Ferguson', email: 'lockie.f@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_34', firstName: 'Martin', lastName: 'Guptill', email: 'martin.g@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_35', firstName: 'Ish', lastName: 'Sodhi', email: 'ish.s@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_36', firstName: 'Gary', lastName: 'Stead', email: 'gary.s@coach.com', roles: ['Coach'], notificationPreferences: { email: true, push: false } },

        // DHS Players
        { personId: 'p_37', firstName: 'Babar', lastName: 'Azam', email: 'babar.a@example.com', roles: ['Player', 'Captain'], notificationPreferences: { email: true, push: false } },
        // ... more players
        { personId: 'p_38', firstName: 'Shaheen', lastName: 'Afridi', email: 'shaheen.a@example.com', roles: ['Player', 'Vice-Captain'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_39', firstName: 'Mohammad', lastName: 'Rizwan', email: 'mohammad.r@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_40', firstName: 'Shadab', lastName: 'Khan', email: 'shadab.k@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_41', firstName: 'Fakhar', lastName: 'Zaman', email: 'fakhar.z@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_42', firstName: 'Haris', lastName: 'Rauf', email: 'haris.r@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_43', firstName: 'Imam-ul-Haq', email: 'imam.h@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_44', firstName: 'Hasan', lastName: 'Ali', email: 'hasan.a@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_45', firstName: 'Shoaib', lastName: 'Malik', email: 'shoaib.m@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_46', firstName: 'Iftikhar', lastName: 'Ahmed', email: 'iftikhar.a@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
        { personId: 'p_47', firstName: 'Naseem', lastName: 'Shah', email: 'naseem.s@example.com', roles: ['Player'], notificationPreferences: { email: true, push: false } },
